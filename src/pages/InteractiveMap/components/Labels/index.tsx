...
import labelNamesZh from '@/data/label_names_zh.json';
...
const labelNameMap = labelNamesZh as Record<string, string>;
    ...
    return (
      <Group>
        {labels.map((label) => {
          ...
          const displayText = labelNameMap[label.text] || label.text;
          return (
            <Text
